...
export function BakedCity(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/models/uncomp.glb") as GLTFResult;
  return (
...
useGLTF.preload("/models/uncomp.glb");
